...
C     CHARACTER*2 TTT(11)
     ...
     2 ALL(100), YY(100)  !FICHIER DE TRACE
        Dimension  absoru2_zp(30)  !pour LECTUR et abonio
C
C     Commons avec les sp d'absorption continue

        COMMON/NOM/absoru2_nomet(30) /ABSO1/absoru2_nm /SAPU/PE,RHO,TOC,ZNH(13)
        ...
        COMMON/LECT1/ABMET,ABHEL /TITIOLINE/absoru2_titre(5)
C
