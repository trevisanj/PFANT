! Nulbadgrade completely original, except for keyboard inputs which
! were hard-coded.
! The purpose of this project is debugging my new version.
...
c        end do
   60     CONTINUE
      ...
      !read(5,200) flcv
      flcv = 'fl.norm.nulbadgrade_original'


      open(unit=8,status='replace',file=flcv)
