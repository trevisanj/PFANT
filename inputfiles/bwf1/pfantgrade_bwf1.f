...
c
c     2) troquei nome do arquivo de atomos para 'atom4070g.dat' e o de
...
C       C6=4.*PI*C
C       C7 = SQRT( PI )
      OPEN(UNIT=4,FILE='main_pfantgrade_bwf1.dat',STATUS='OLD')
...
C
      OPEN(UNIT=15,STATUS='OLD',FILE='absoru.dat')
