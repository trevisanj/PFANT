...
# Table of contents
  ...
  1. [Introduction](#S1)
  2. [Installation](#S2)
  3. [Command-line operation](#S3)
  4. [Graphical interface operation](#S4)
  5. [Writing Python scripts with _pyfant_ package](#S5)
  6. [Reference](#S6)
  7. [Other topics](#S7)
  8. [Links](#S8)
  9. [Troubleshooting](#S9)
  10. [References](#S10)
...
4. Install **pyfant** (Python interface) (part of http://github.com/trevisanj/astrogear) (recommended)
...
This section uses the _pyfant_ Python package,
which is available at http://github.com/trevisanj/astrogear. Please install it to follow this tutorial.
...
## 3.2.3 Spectral synthesis pipeline
...
#### 3.23.1 Interpolate the stellar atmospheric model
...
#### 3.2.3.2 Create hydrogen lines profiles
...
#### 3.2.3.3 Calculate synthetic spectrum
...
#### 3.2.3.4 Convolve synthetic spectrum with Gaussian function
...
#### 3.2.3.6 Running the four calculation steps at once
...
## 6.1 Spectral synthesis pipeline
...
### 6.2.3 Files created by the Fortran programs

#### 6.2.3.1 Files created by `innewmarcs`
...
#### 6.2.3.2 Files created by `hydro2`
...
#### 6.2.3.3 Files created by `pfant`
...
#### 6.2.3.4 Files created by `nulbad`
...
# <a name=S9></a>9 Troubleshooting

## 9.1 Tracking down why Fortran binaries fail to run
...
## 9.2 Metallicity/temperature/gravity of star is outside range in the grid of models
